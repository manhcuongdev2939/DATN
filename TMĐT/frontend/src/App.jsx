      ...
      cartAPI.get()
        .then(result => {
          if (result.items && Array.isArray(result.items)) {
            const totalItems = result.items.reduce((sum, item) => sum + (item.So_luong || 0), 0);
            ...
            {user ? (
              <>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Khám phá những sản phẩm công nghệ mới nhất với ưu đãi đặc biệt dành cho bạn.
                </p>
              </>
            ) : (
              <>
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 mb-4">
                  Laptop & Điện thoại<br />chính hãng
                </h1>
                <p className="text-lg text-gray-600 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#categories" className="hover:text-white transition-colors">Danh mục</a>
              </li>
              <li>
                <a href="#featured" className="hover:text-white transition-colors">Sản phẩm nổi bật</a>
              </li>
              <li>
        ...
        {recentOrders.length > 0 && (
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/orders" className="text-sm text-brand-600 hover:text-brand-700 font-medium">
                Xem tất cả →
              </Link>
            </div>
  ...
  return (
    <div className="min-h-full flex flex-col">
      ...
      <main className="flex-1">
        <Routes>
          <Route path="/" element={<HomePage user={user} onLoginClick={() => setShowAuthModal(true)} onCartClick={() => {
            if (!user) {
              setShowAuthModal(true);
            } else {
              setShowCartModal(true);
